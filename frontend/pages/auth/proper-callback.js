...
export default function ProperCallback() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      console.log('Proper callback received:', { token: !!token, refresh: !!refresh, error: urlError });
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 via-teal-100 to-white">
        <Card className="p-8 max-w-md w-full text-center">
          ...
          <Button onClick={() => router.push("/auth/proper-login")} className="w-full">
            Try Again
          </Button>
        </Card>
      </div>
